...
import static net.canarymod.commandsys.CanaryCommandPermissions.EFFECT$OTHER;
...
public final class Effect extends VanillaCommandWrapper {
    ...
    public void execute(MessageReceiver caller, String[] parameters) {
        if (isNotSelfOrServer(caller, parameters[0]) && !caller.hasPermission(EFFECT$OTHER)) {
