 ...
 * 
 * CanaryTeam Notes:
 * This file is included to avoid the use of proprietary sources and to avoid the use of a library just for this one function.
 * Until we finally decide that we need Netty in the Lib or Java incorporates Base64 in the public API
 */
