...
public class InvalidPacketConstructionException extends Exception {
    ...
    public InvalidPacketConstructionException(int packetID, String name, String extra) {
        super(String.format(construct_fail, packetID, Integer.toHexString(packetID), name, extra));
    }
}
