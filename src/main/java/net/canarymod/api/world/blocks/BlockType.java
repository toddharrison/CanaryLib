...
public final class BlockType {
    ...
    public static final BlockType SpruceWood = new BlockType(5, 1, "Spruce Wood", "minecraft:planks:1");
    public static final BlockType BirchWood = new BlockType(5, 2, "Birch Wood", "minecraft:planks:2");
    public static final BlockType JungleWood = new BlockType(5, 3, "Jungle Wood", "minecraft:planks:3");
    public static final BlockType AcaciaWood = new BlockType(5, 4, "Acacia Wood", "minecraft:planks:4");
    public static final BlockType DarkOakWood = new BlockType(5, 4, "Dark Oak Wood", "minecraft:planks:5");
    public static final BlockType OakSapling = new BlockType(6, 0, "Oak Sapling", "minecraft:sapling");
    public static final BlockType SpruceSapling = new BlockType(6, 1, "Spruce Sapling", "minecraft:sapling:1");
    public static final BlockType BirchSapling = new BlockType(6, 2, "Birch Sapling", "minecraft:sapling:2");
    public static final BlockType JungleSapling = new BlockType(6, 3, "Jungle Sapling", "minecraft:sapling:3");
    public static final BlockType AcaciaSapling = new BlockType(6, 4, "Acacia Sapling", "minecraft:sapling:4");
    public static final BlockType DarkOakSapling = new BlockType(6, 5, "Dark Oak Sapling", "minecraft:sapling:5");
    ...
    public static final BlockType PineLog = new BlockType(17, 1, "Pine Log", "minecraft:log:1");
    public static final BlockType BirchLog = new BlockType(17, 2, "Birch Log", "minecraft:log:2");
    public static final BlockType JungleLog = new BlockType(17, 3, "Jungle Log", "minecraft:log:3");
    public static final BlockType OakLeaves = new BlockType(18, 0, "Oak Leaves", "minecraft:leaves");
    public static final BlockType PineLeaves = new BlockType(18, 1, "Pine Needles", "minecraft:leaves:1");
    public static final BlockType BirchLeaves = new BlockType(18, 2, "Birch Leaves", "minecraft:leaves:2");
    public static final BlockType JungleLeaves = new BlockType(18, 3, "Jungle Leaves", "minecraft:leaves:3");
    ...
    public static final BlockType SandstoneOrnate = new BlockType(24, 1, "Ornate Sandstone", "minecraft:sandstone:1");
    public static final BlockType SandstoneBlank = new BlockType(24, 2, "Blank Sandstone", "minecraft:sandstone:2");
    ...
    public static final BlockType TallGrass = new BlockType(31, 1, "Grass", "minecraft:tallgrass:1");
    public static final BlockType Fern = new BlockType(31, 2, "Fern", "minecraft:tallgrass:2");
    ...
    public static final BlockType WoolOrange = new BlockType(35, 1, "Orange Wool", "minecraft:wool:1");
    public static final BlockType WoolMagenta = new BlockType(35, 2, "Magenta Wool", "minecraft:wool:2");
    public static final BlockType WoolLightBlue = new BlockType(35, 3, "Light Blue Wool", "minecraft:wool:3");
    public static final BlockType WoolYellow = new BlockType(35, 4, "Yellow Wool", "minecraft:wool:4");
    public static final BlockType WoolLightGreen = new BlockType(35, 5, "Light Green Wool", "minecraft:wool:5");
    public static final BlockType WoolPink = new BlockType(35, 6, "Pink Wool", "minecraft:wool:6");
    public static final BlockType WoolGray = new BlockType(35, 7, "Gray Wool", "minecraft:wool:7");
    public static final BlockType WoolLightGray = new BlockType(35, 8, "Light Gray Wool", "minecraft:wool:8");
    public static final BlockType WoolCyan = new BlockType(35, 9, "Cyan Wool", "minecraft:wool:9");
    public static final BlockType WoolPurple = new BlockType(35, 10, "Purple Wool", "minecraft:wool:10");
    public static final BlockType WoolBlue = new BlockType(35, 11, "Blue Wool", "minecraft:wool:11");
    public static final BlockType WoolBrown = new BlockType(35, 12, "Brown Wool", "minecraft:wool:12");
    public static final BlockType WoolDarkGreen = new BlockType(35, 13, "Dark Green Wool", "minecraft:wool:13");
    public static final BlockType WoolRed = new BlockType(35, 14, "Red Wool", "minecraft:wool:14");
    public static final BlockType WoolBlack = new BlockType(35, 15, "Black Wool", "minecraft:wool:15");
    ...
    public static final BlockType BlueOrchid = new BlockType(38, 1, "Blue Orchid", "minecraft:red_flower:1");
    public static final BlockType Allium = new BlockType(38, 2, "Allium", "minecraft:red_flower:2");
    public static final BlockType AzureBluet = new BlockType(38, 3, "Azure Bluet", "minecraft:red_flower:3");
    public static final BlockType RedTulip = new BlockType(38, 4, "Red Tulip", "minecraft:red_flower:4");
    public static final BlockType OrangeTulip = new BlockType(38, 5, "Orange Tulip", "minecraft:red_flower:5");
    public static final BlockType WhiteTulip = new BlockType(38, 6, "White Tulip", "minecraft:red_flower:6");
    public static final BlockType PinkTulip = new BlockType(38, 7, "Pink Tulip", "minecraft:red_flower:7");
    public static final BlockType OxeyeDaisy = new BlockType(38, 8, "Oxeye Daisy", "minecraft:red_flower:8");
    ...
    public static final BlockType DoublestepSandStoneTrim = new BlockType(43, 1, "Doublestep Sandstone Trim", "minecraft:double_stone_slab:1");
    public static final BlockType DoublestepWood = new BlockType(43, 2, "Doublestep Wood","minecraft:double_stone_slab:2");
    public static final BlockType DoublestepCobble = new BlockType(43, 3, "Doublestep Cobble","minecraft:double_stone_slab:3");
    public static final BlockType DoublestepBrickBlock = new BlockType(43, 4, "Doublestep Bricks","minecraft:double_stone_slab:4");
    public static final BlockType DoublestepStoneBricks = new BlockType(43, 5, "Doublestep Stone Bricks","minecraft:double_stone_slab:5");
    public static final BlockType DoublestepNetherBrick = new BlockType(43, 6, "Doublestep Nether Bricks","minecraft:double_stone_slab:6");
    public static final BlockType DoublestepQuartz = new BlockType(43, 9, "Doublestep Quartz" , "minecraft:double_stone_slab:7");
    public static final BlockType DoublestepStone = new BlockType(43, 8, "Doublestep Stone" , "minecraft:double_stone_slab:8");
    public static final BlockType DoublestepSandStone = new BlockType(43, 11, "Doublestep Sandstone" , "minecraft:double_stone_slab:9");
    public static final BlockType StepOrnateStone = new BlockType(44, 0, "Ornate Stone Step" , "minecraft:stone_slab");
    public static final BlockType StepSandStoneTrim = new BlockType(44, 1, "Sandstone Trim Step" , "minecraft:stone_slab:1");
    public static final BlockType StepWood = new BlockType(44, 2, "Wood Step" , "minecraft:stone_slab:2");
    public static final BlockType StepCobble = new BlockType(44, 3, "Cobble Step" , "minecraft:stone_slab:3");
    public static final BlockType StepBrickBlock = new BlockType(44, 4, "Bricks Step" , "minecraft:stone_slab:4");
    public static final BlockType StepStoneBricks = new BlockType(44, 5, "Stone Bricks Step" , "minecraft:stone_slab:5");
    public static final BlockType StepNetherBricks = new BlockType(44, 6, "Nether Bricks Step" , "minecraft:stone_slab:6");
    public static final BlockType StepQuartz = new BlockType(44, 7, "Quartz Step" , "minecraft:stone_slab:7");
    public static final BlockType StepStone = new BlockType(44, 10, "Stone Step" , "minecraft:stone_slab:8");
    public static final BlockType StepSandStone = new BlockType(44, 11, "Sandstone Step", "minecraft:stone_slab:9");
    ...
    public static final BlockType OrangeGlass = new BlockType(95, 1, "Orange Glass" , "minecraft:stained_glass:1");
    public static final BlockType MagentaGlass = new BlockType(95, 2, "Magenta Glass" , "minecraft:stained_glass:2");
    public static final BlockType LightBlueGlass = new BlockType(95, 3, "Light Blue Glass" , "minecraft:stained_glass:3");
    public static final BlockType YellowGlass = new BlockType(95, 4, "Yellow Glass" , "minecraft:stained_glass:4");
    public static final BlockType LimeGlass = new BlockType(95, 5, "Lime Glass" , "minecraft:stained_glass:5");
    public static final BlockType PinkGlass = new BlockType(95, 6, "Pink Glass" , "minecraft:stained_glass:6");
    public static final BlockType GrayGlass = new BlockType(95, 7, "Gray Glass" , "minecraft:stained_glass:7");
    public static final BlockType LightGrayGlass = new BlockType(95, 8, "Light Gray Glass" , "minecraft:stained_glass:8");
    public static final BlockType CyanGlass = new BlockType(95, 9, "Cyan Glass" , "minecraft:stained_glass:9");
    public static final BlockType PurpleGlass = new BlockType(95, 10, "Purple Glass" , "minecraft:stained_glass:10");
    public static final BlockType BlueGlass = new BlockType(95, 11, "Blue Glass" , "minecraft:stained_glass:11");
    public static final BlockType BrownGlass = new BlockType(95, 12, "Brown Glass" , "minecraft:stained_glass:12");
    public static final BlockType GreenGlass = new BlockType(95, 13, "Green Glass" , "minecraft:stained_glass:13");
    public static final BlockType RedGlass = new BlockType(95, 14, "Red Glass" , "minecraft:stained_glass:14");
    public static final BlockType BlackGlass = new BlockType(95, 15, "Black Glass" , "minecraft:stained_glass:15");
    ...
    public static final BlockType MossySilverFishBlock = new BlockType(97, 1, "Mossy Silverfish Spawnblock" , "minecraft:monster_egg:1");
    public static final BlockType CrackdSilverFishBlock = new BlockType(97, 2, "Cracked Silverfish Spawnblock" , "minecraft:monster_egg:2");
    public static final BlockType OrnateSilverFishBlock = new BlockType(97, 3, "Ornate Silverfish Spawnblock" , "minecraft:monster_egg:3");
    public static final BlockType StoneBrick = new BlockType(98, 0, "Stone Bricks" , "minecraft:stonebrick");
    public static final BlockType MossyStoneBrick = new BlockType(98, 1, "Mossy Stone Bricks" , "minecraft:stonebrick:1");
    public static final BlockType CrackedStoneBrick = new BlockType(98, 2, "Cracked Stone Bricks" , "minecraft:stonebrick:2");
    public static final BlockType OrnateStoneBrick = new BlockType(98, 3, "Ornate Stone Bricks" , "minecraft:stonebrick:3");
    ...
    public static final BlockType SpruceWoodDoubleStep = new BlockType(125, 1, "Spruce Wood Doublestep" , "minecraft:double_wooden_slab:1");
    public static final BlockType BirchWoodDoubleStep = new BlockType(125, 2, "Birch Wood Doublestep" , "minecraft:double_wooden_slab:2");
    public static final BlockType JungleWoodDoubleStep = new BlockType(125, 3, "Jungle Wood Doublestep" , "minecraft:double_wooden_slab:3");
    public static final BlockType AcaciaWoodDoubleStep = new BlockType(125, 4, "Acacia Wood Doublestep" , "minecraft:double_wooden_slab:4");
    public static final BlockType DarkOakWoodDoubleStep = new BlockType(125, 5, "Dark Oak Wood Doublestep" , "minecraft:double_wooden_slab:5");
    public static final BlockType OakWoodStep = new BlockType(126, 0, "Oak Woodstep" , "minecraft:wooden_slab");
    public static final BlockType SpruceWoodStep = new BlockType(126, 1, "Spruce Woodstep" , "minecraft:wooden_slab:1");
    public static final BlockType BirchWoodStep = new BlockType(126, 2, "Birch Woodstep" , "minecraft:wooden_slab:2");
    public static final BlockType JungleWoodStep = new BlockType(126, 3, "Jungle Woodstep" , "minecraft:wooden_slab:3");
    public static final BlockType AcaciaWoodStep = new BlockType(126, 4, "Acacia Woodstep" , "minecraft:wooden_slab:4");
    public static final BlockType DarkOakWoodStep = new BlockType(126, 5, "Dark Oak Woodstep" , "minecraft:wooden_slab:5");
    ...
    public static final BlockType WitherSkeletonHead = new BlockType(144, 1, "Wither Skeleton Head" , "minecraft:skull:1");
    public static final BlockType ZombieHead = new BlockType(144, 2, "Zombie Head" , "minecraft:skull:2");
    public static final BlockType HumanHead = new BlockType(144, 3, "Human Head" , "minecraft:skull:3");
    public static final BlockType CreeperHead = new BlockType(144, 4, "Creeper Head" , "minecraft:skull:4");
    ...
    public static final BlockType OrnateQuartzBlock = new BlockType(155, 1, "Ornate Quartz Block" , "minecraft:quartz_block:1");
    public static final BlockType QuartzPillarVertical = new BlockType(155, 2, "Quartz Pillar Vertical" , "minecraft:quartz_block:2");
    public static final BlockType QuartzPillarHorizontal = new BlockType(155, 3, "Quartz Pillar Horizontal" , "minecraft:quartz_block:3");
    public static final BlockType QuartzPillarCap = new BlockType(155, 4, "Quartz Pillar Cap" , "minecraft:quartz_block:4");
    ...
    public static final BlockType OrangeStainedClay = new BlockType(159, 1, "Orange Stained Clay" , "minecraft:stained_hardened_clay:1");
    public static final BlockType MagentaStainedClay = new BlockType(159, 2, "Magenta Stained Clay" , "minecraft:stained_hardened_clay:2");
    public static final BlockType LightBlueStainedClay = new BlockType(159, 3, "LightBlue Stained Clay" , "minecraft:stained_hardened_clay:3");
    public static final BlockType YellowStainedClay = new BlockType(159, 4, "Yellow Stained Clay" , "minecraft:stained_hardened_clay:4");
    public static final BlockType LimeStainedClay = new BlockType(159, 5, "Lime Stained Clay" , "minecraft:stained_hardened_clay:5");
    public static final BlockType PinkStainedClay = new BlockType(159, 6, "Pink Stained Clay" , "minecraft:stained_hardened_clay:6");
    public static final BlockType GrayStainedClay = new BlockType(159, 7, "Gray Stained Clay" , "minecraft:stained_hardened_clay:7");
    public static final BlockType LightGrayStainedClay = new BlockType(159, 8, "LightGray Stained Clay" , "minecraft:stained_hardened_clay:8");
    public static final BlockType CyanStainedClay = new BlockType(159, 9, "Cyan Stained Clay" , "minecraft:stained_hardened_clay:9");
    public static final BlockType PurpleStainedClay = new BlockType(159, 10, "Purple Stained Clay" , "minecraft:stained_hardened_clay:10");
    public static final BlockType BlueStainedClay = new BlockType(159, 11, "Blue Stained Clay" , "minecraft:stained_hardened_clay:11");
    public static final BlockType BrownStainedClay = new BlockType(159, 12, "Brown Stained Clay" , "minecraft:stained_hardened_clay:12");
    public static final BlockType GreenStainedClay = new BlockType(159, 13, "Green Stained Clay" , "minecraft:stained_hardened_clay:13");
    public static final BlockType RedStainedClay = new BlockType(159, 14, "Red Stained Clay" , "minecraft:stained_hardened_clay:14");
    public static final BlockType BlackStainedClay = new BlockType(159, 15, "Black Stained Clay" , "minecraft:stained_hardened_clay:15");
    public static final BlockType WhiteGlassPane = new BlockType(160, 0, "White Glass Pane" , "minecraft:stained_glass_pane");
    public static final BlockType OrangeGlassPane = new BlockType(160, 1, "Orange Glass Pane" , "minecraft:stained_glass_pane:1");
    public static final BlockType MagentaGlassPane = new BlockType(160, 2, "Magenta Glass Pane" , "minecraft:stained_glass_pane:2");
    public static final BlockType LightBlueGlassPane = new BlockType(160, 3, "Light Blue Glass Pane" , "minecraft:stained_glass_pane:3");
    public static final BlockType YellowGlassPane = new BlockType(160, 4, "Yellow Glass Pane" , "minecraft:stained_glass_pane:4");
    public static final BlockType LimeGlassPane = new BlockType(160, 5, "Lime Glass Pane" , "minecraft:stained_glass_pane:5");
    public static final BlockType PinkGlassPane = new BlockType(160, 6, "Pink Glass Pane" , "minecraft:stained_glass_pane:6");
    public static final BlockType GrayGlassPane = new BlockType(160, 7, "Gray Glass Pane" , "minecraft:stained_glass_pane:7");
    public static final BlockType LightGrayGlassPane = new BlockType(160, 8, "Light Gray Glass Pane" , "minecraft:stained_glass_pane:8");
    public static final BlockType CyanGlassPane = new BlockType(160, 9, "Cyan Glass Pane" , "minecraft:stained_glass_pane:9");
    public static final BlockType PurpleGlassPane = new BlockType(160, 10, "Purple Glass Pane" , "minecraft:stained_glass_pane:10");
    public static final BlockType BlueGlassPane = new BlockType(160, 11, "Blue Glass Pane" , "minecraft:stained_glass_pane:11");
    public static final BlockType BrownGlassPane = new BlockType(160, 12, "Brown Glass Pane" , "minecraft:stained_glass_pane:12");
    public static final BlockType GreenGlassPane = new BlockType(160, 13, "Green Glass Pane" , "minecraft:stained_glass_pane:13");
    public static final BlockType RedGlassPane = new BlockType(160, 14, "Red Glass Pane" , "minecraft:stained_glass_pane:14");
    public static final BlockType BlackGlassPane = new BlockType(160, 15, "Black Glass Pane" , "minecraft:stained_glass_pane:15");
    public static final BlockType AcaciaLeaves = new BlockType(161,0, "Leaves Acacia" , "minecraft:leaves2");
    public static final BlockType DarkOakLeaves = new BlockType(161,1, "Leaves Dark Oak" , "minecraft:leaves2:1");
    public static final BlockType AcaciaLog = new BlockType(162,0, "Log Acacia" , "minecraft:log2");
    public static final BlockType DarkOakLog = new BlockType(162,1, "Log Dark Oak" , "minecraft:log2:1");
    ...
    public static final BlockType OrangeCarpet = new BlockType(171, 1, "Orange Carpet" , "minecraft:carpet:1");
    public static final BlockType MagentaCarpet = new BlockType(171, 2, "Magenta Carpet" , "minecraft:carpet:2");
    public static final BlockType LightBlueCarpet = new BlockType(171, 3, "LightBlue Carpet" , "minecraft:carpet:3");
    public static final BlockType YellowCarpet = new BlockType(171, 4, "Yellow Carpet" , "minecraft:carpet:4");
    public static final BlockType LimeCarpet = new BlockType(171, 5, "Lime Carpet" , "minecraft:carpet:5");
    public static final BlockType PinkCarpet = new BlockType(171, 6, "Pink Carpet" , "minecraft:carpet:6");
    public static final BlockType GrayCarpet = new BlockType(171, 7, "Gray Carpet" , "minecraft:carpet:7");
    public static final BlockType LightGrayCarpet = new BlockType(171, 8, "LightGray Carpet" , "minecraft:carpet:8");
    public static final BlockType CyanCarpet = new BlockType(171, 9, "Cyan Carpet" , "minecraft:carpet:9");
    public static final BlockType PurpleCarpet = new BlockType(171, 10, "Purple Carpet" , "minecraft:carpet:10");
    public static final BlockType BlueCarpet = new BlockType(171, 11, "Blue Carpet" , "minecraft:carpet:11");
    public static final BlockType BrownCarpet = new BlockType(171, 12, "Brown Carpet" , "minecraft:carpet:12");
    public static final BlockType GreenCarpet = new BlockType(171, 13, "Green Carpet" , "minecraft:carpet:13");
    public static final BlockType RedCarpet = new BlockType(171, 14, "Red Carpet" , "minecraft:carpet:14");
    public static final BlockType BlackCarpet = new BlockType(171, 15, "Black Carpet" , "minecraft:carpet:15");
    ...
    public static final BlockType Lilac = new BlockType(175, 1, "Lilac" , "minecraft:double_plant:1");
    public static final BlockType DoubleGrass = new BlockType(175, 2, "Double Grass" , "minecraft:double_plant:2");
    public static final BlockType LargeFern = new BlockType(175, 3, "Large Fern" , "minecraft:double_plant:3");
    public static final BlockType RoseBush = new BlockType(175, 4, "Rose Bush" , "minecraft:double_plant:4");
    public static final BlockType Peony = new BlockType(175, 5, "Peony" , "minecraft:double_plant:5");
